...
<body>
    <nav class="navbar">
        <ul class="navbar-nav">
            ...
            <li class="navbar-item active"><a href="../current/current.php" class="nav-link"><svg class="mobile-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg><span>Stagiaires actuels</span></a></li>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        // Back and Next links
                        echo "<tr>";
                        echo "<td colspan='9'> <a class='prev-page' href=?" . "page=$back" . '><svg class="back-next" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"/></svg></a>';
